...
import * as Constants from '../constants/Constants'; // TODO fix this
  ...
  switch (action.type) {
    case Constants.ACTIONS.RESET_GAME: {
      ...
      return Object.assign({}, {
        ...
        newMoveInterval: state.newMoveInterval ? clearInterval(state.newMoveInterval) : null
      });
    }

    case Constants.ACTIONS.START_AI_GAME: {
      return Object.assign({}, state, {
        startAiGame: true,
        newMoveInterval: setInterval (() => {
          action.moveCallback();
